    ...
    <div class="page_body">
        <div class="flex justify-center">
            <ol>
                ...
                <li class="border-l-2 border-gray-600">
                    <div class="md:flex flex-start">
                    ...
                    <div class="block p-6 rounded-lg shadow-lg bg-lite-neptune max-w-md ml-6 mb-10">
                        ...
                        <button type="button" class="inline-block px-4 py-1.5 bg-gray-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-gray-700 hover:shadow-lg focus:bg-gray-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-800 active:shadow-lg transition duration-150 ease-in-out" data-mdb-ripple="true">Preview</button>
                    </div>
                    </div>
                </li>
                <li class="border-l-2 border-gray-600">
                    ...
                    <div class="block p-6 rounded-lg shadow-lg bg-lite-neptune max-w-md ml-6 mb-10">
                        ...
                        <p class="text-gray-700 mb-6">
                            ...
                            ＲＢＣウクライナ通信は、２つの爆発が起きたと伝えた。
                            ロシアの報道機関バザは地元住民の話をもとに、空襲のサイレンが鳴り響き、爆発音が聞こえたと報じた。
                            エンゲリス空軍基地は首都モスクワから約７３０キロ南東に位置するサラトフ州にある。ロシア側は、この基地ともう一つの空軍基地が１２月５日にウクライナのドローン攻撃を受けたと主張している。
                            専門家は、２基地への攻撃でロシアの評判は大きく傷つき、防衛システムで攻撃を防げなかったことに疑問が浮上したと指摘した。
