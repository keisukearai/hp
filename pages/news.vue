                ...
                <div class="flex md:w-2/5">
                    ...
                    <span class="ml-2">
                        <button
                            ...
                            <span class="inline-flex items-center justify-center w-10 h-4 ml-2 text-xs font-semibold text-blue-800 bg-blue-200 rounded-md">
                                {{ newsCount }}件
                            </span>
                        </button>
                    </span>
                                ...
                                <div class="block p-6 rounded-lg shadow-lg bg-gray-100 ml-6 mb-10">
                                    ...
                                    <div class="flex justify-between">
                                        <div class="font-medium text-gray-600 duration-300 transition ease-in-out text-sm pr-5">
                                            {{ $dayjs(article.entry_date).format('YYYY/MM/DD HH:mm:ss') }}
                                        </div>
